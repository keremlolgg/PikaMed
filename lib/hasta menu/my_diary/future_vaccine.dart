...
import 'package:Marul_Tarlasi/hasta menu/models/future_list_data.dart';
import 'package:Marul_Tarlasi/main.dart';
import 'package:flutter/material.dart';


class FutureVaccine extends StatefulWidget {
  const FutureVaccine(
  ...
  @override
  _FutureVaccineState createState() => _FutureVaccineState();
}

class _FutureVaccineState extends State<FutureVaccine>
    with TickerProviderStateMixin {
  AnimationController? animationController;
  List<FutureInsulinListData> mealsListData = FutureInsulinListData.insulinList;
...
class MealsView extends StatelessWidget {
  ...
  final FutureInsulinListData? insulinList;
