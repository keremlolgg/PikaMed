...
class PastVaccine extends StatefulWidget {
  ...
  @override
  _PastVaccineState createState() => _PastVaccineState();
}
            ...
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  final int count =
                  InsulinListData.pastInsulinList.length > 10 ? 10 : InsulinListData.pastInsulinList.length;
                  ...
                  return MealsView(
                    insulinList: InsulinListData.pastInsulinList[index],
                    animation: animation,
                    animationController: animationController!,
                  );
                },
