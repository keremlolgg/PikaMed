...
class _DoktorHomeScreenState extends State<DoktorHomeScreen>
  ...
  String searchQuery = '';
  List<PatientListData> filteredList = PatientListData.patientsList;
                        ...
                        body: Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              final int count = filteredList.length > 10 ? 10 : filteredList.length;
                              ...
                              return PatientListView(
                                callback: () {},
                                patientsList: filteredList[index],
                                animation: animation,
                                animationController: animationController!,
                              );
                            },
  ...
  void _filterSearchResults(String query) {
    setState(() {
      ...
      filteredList = PatientListData.patientsList
          .where((patient) =>
      patient.name.toLowerCase().contains(searchQuery) ||
          patient.disease.toLowerCase().contains(searchQuery))
          .toList();
    });
  }
              ...
              children: <Widget>[
                Expanded(
                  child: Padding(
                    ...
                    child: Text(
                      'Gösterilen hasta sayısı: ${filteredList.length}',
                      style: TextStyle(
